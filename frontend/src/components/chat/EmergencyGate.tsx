    ...
    return (
        <Modal tone="danger" labelledBy="urgent-title" dismissible={false}>
            <div className="mb-4 flex items-center gap-3">
                ...
                <h2
                    id="urgent-title"
                    className="m-0 text-xl font-bold uppercase tracking-widest text-neutral-900 dark:text-neutral-100"
                >
                    Urgency: Emergency
                </h2>
            </div>
            ...
            <label
                className="mb-1 block text-sm uppercase tracking-wider text-neutral-400"
                htmlFor="ack-input"
            >
