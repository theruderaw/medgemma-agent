...
export default function PrescriptionCard({ data }: { data: PrescriptionData }) {
    ...
    return (
        <div className="mb-2 w-full overflow-hidden rounded-lg border border-neutral-300 bg-white text-sm dark:border-neutral-700 dark:bg-neutral-950">
            <div className="flex items-center gap-2 border-b border-neutral-200 bg-neutral-100 px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-neutral-600 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300">
            ...
            {names.length === 0 ? (
                <p className="px-3 py-2 text-sm italic text-neutral-500">
                    ...
                    {names.map((name) => {
                        ...
                        return (
                            <li key={name} className="px-3 py-2">
                                ...
                                <dl className="mt-1 grid grid-cols-[max-content_1fr] gap-x-3 gap-y-0.5 text-sm text-neutral-700 dark:text-neutral-300">
            ...
            <p className="border-t border-neutral-200 px-3 py-1.5 text-xs text-neutral-500 dark:border-neutral-800">
