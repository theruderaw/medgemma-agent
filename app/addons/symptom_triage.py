"""Symptom-triage addon — the existing MedGemma triage, router-selectable.
...
request flag path in ``run_chat_turn`` is untouched. Registering this addon
...
from ..prompts.composed import TRIAGE_INSTRUCTIONS, triage_context_for
from ..prompts.formats import TRIAGE_FORMAT
from ..registry import SafetyProfile, ToolSchema


class SymptomTriageAddon:
    ...
    tool_schema = ToolSchema(
        ...
        description=(
            ...
            "instead of a full clinical assessment for ambiguous or "
